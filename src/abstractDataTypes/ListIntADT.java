...
public interface ListIntADT {
	...
	public void insert(int i, int j); 	// Insert an integer j at any position i of the list.
	...
	public void replace(int i, int j);	// Replace an integer at any position i by another element j.
